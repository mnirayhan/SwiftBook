    ...
    BaseWebView(
        ...
        onPostLoad = {
            ...
            val scripts = listOf(
                ...
                Script(!isDesktop.value, R.raw.messenger_scripts, "$cdnBase/messenger_scripts.js"),
                Script(facebookLiteMode.value && !isDesktop.value, R.raw.fb_lite_ui, "$cdnBase/fb_lite_ui.js") // FB Lite UI for mobile only if enabled
            )
